...
export default function Connect() {
  return (
    <main className="min-h-screen w-full relative overflow-hidden ">
      ...
      <div className="absolute w-full h-full z-30 flex flex-col items-center justify-center gap-8">
        ...
        <div className="flex flex-col w-full px-2 md:w-xl z-30">
          <Link href={"https://www.linkedin.com/in/joseguerra5"} target="_blank" className="w-full cursor-pointer">
          ...
          <Link href={"https://github.com/joseguerra5"} target="_blank" className="w-full cursor-pointer">
          ...
          <Link href={"mailto:jose.luiz.guerra1@gmail.com"} target="_blank" className="w-full cursor-pointer">
